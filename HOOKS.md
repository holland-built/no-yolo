...
Hook scripts in `~/.claude/hooks/` run automatically at harness events configured in `settings.json`.
...
- **statusline.sh** — displays context %, 5h limit %, 7d limit % in the Claude Code status bar.
