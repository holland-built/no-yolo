# Changelog — July 2026 (archived)

Moved out of `docs/DAILY_CHANGELOG.md` on 2026-08-02. These entries were written in the old
long form, which duplicated the commit messages almost word for word — a comparison of one
entry against its commit shared 66 of 72 distinctive words. Kept verbatim rather than
rewritten: squeezing 43 entries down from memory is exactly how detail goes missing.
