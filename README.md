...
| `/md-check` | Audits every `~/.claude/` doc for size, over-200-line bloat, and duplicate topics; `--fix` applies the fixes it finds | `--fix` (apply, `--auto` to skip gate) · `--drift` · `--pre FILENAME` |
