...
| **Chrome** (headless) | 147.x | design-fast, design-full, build | Screenshots HTML mockups so you can see them inline without opening a browser. | Any mockup generation | Pre-installed on most systems | See the mockup without opening a browser tab |
