...
| --- | --- | --- | --- |
| design | Fresh UI mockup generation | design-audit | 5-lens UI violation audit |
...
| diagnose | Root-cause bug analysis | debate | 6-persona decision debate |
| improve | Deep audit, generates plans | prompt-scan | Scan prompts, log learnings |
| better-prompt | Sharpen a rough prompt | drawio-skill | Generate diagrams, export images |
| remember-that | Save facts across sessions | my-skills | This skill menu |
| whats-next | Shows unfinished work | ship | Commit + publish, one command |
| eli5 | Plain-English explain anything | my-md | List all markdown files |
| md-check | Audit docs for bloat | skill-audit | Audit skill library health |
