...
| build | plan, tdd, ui-ux, code-review, code-health, *impeccable*, **Playwright**, **graphify**, Opus+Sonnet agents | 7-phase feature pipeline with hard gates | Starting a new feature | `/build [feature]` | Chains every quality gate automatically — you can't skip TDD or proof |
