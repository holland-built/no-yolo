...
ship|Quality-gate + changelog + publish to no-yolo. One command.
debug-debate|6 Opus personas argue bug root cause → diagnosis + next step.
last-30|Trending now (last 30 days) from GitHub, HN, YouTube, X.
md-check|Audit ~/.claude docs for bloat, overlap, duplicate rules.
