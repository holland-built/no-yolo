...
README.md|The no-yolo rules — what actions require your confirmation before Claude takes them. The short list of things Claude should always check with you first.
