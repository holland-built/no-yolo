...
echo ""
echo "    Note: impeccable and workflow-enforcement skills (writing-plans, executing-plans,"
echo "    subagent-driven-development, etc.) install separately:"
echo "      /plugin marketplace add impeccable  (in Claude Code)"
echo "    Workflow enforcement pack: install from Claude Code plugin marketplace"
